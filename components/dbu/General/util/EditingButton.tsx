...
const baseStyle = "flex items-center gap-1.5 text-sm rounded-md transition-colors";

const variantStyles: Record<ButtonVariant, string> = {
  section: "px-3 py-1.5 border border-dbu-header/50 text-dbu-header bg-dbu-header/10 hover:bg-dbu-header/20",
