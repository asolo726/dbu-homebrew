export default function CarouselOption({
  ...
  let selectedCss = "";
  let defaultStyle =
    "m-4 p-3 min-w-60 md:min-w-80 flex flex-col border-4 rounded-xl border-solid border-dbu-link hover:bg-dbu-link cursor-pointer ";
  ...
  return (
    <div
      className={defaultStyle.concat(selectedCss)}
