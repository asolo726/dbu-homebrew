class Legendary {
    constructor(head, traits = [], masteryTrait, legendaryTrait, transformations = []) {
        this._head = head;
        this._traits = traits;
    ...
    get legendaryTrait() { return this._legendaryTrait; }
    set legendaryTrait(value) { this._legendaryTrait = value; }
