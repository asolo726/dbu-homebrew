...
export default function Test_Righteous_Indignation() {
  ...
  const traits = [
    new TraitClass(featureTitle1.title, featureTitle1.desc, featureAbilities1),
    new TraitClass(featureTitle2.title, featureTitle2.desc, featureAbilities2),
  ];
