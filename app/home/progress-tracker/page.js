...
export default function Dashboard() {
  ...
  const transformationMechanicsProgress = calculateProgress(transformationMechanics);
  ...
  const progressBars = [
    ...
    {
      label: "Transformation Mechanics",
      currentProgress: transformationMechanicsProgress,
      color: "grey",
      pageProgress: transformationMechanics,
    }
  ];
